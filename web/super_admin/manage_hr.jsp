...
<style>
    .gradient-custom {
        ...
        background: linear-gradient(to right bottom, rgba(0, 123, 255, 1), rgba(0, 191, 255, 1));
            ...
            <div class="col-12 col-md-12 order-md-2 order-first" style="padding-left: 14px;padding-bottom: 8px;">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb" style="justify-content: flex-start;padding-left: 0px;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage HR</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <tbody>
                        <%
                            ...
                            for(Hr hr : hrList){
                                ...
                                String designationHrOptions = GetDesignationOptions.getHrDesignationOptions(hr.getDeg_id_hr());
                        %>
                        <tr>
                            <td style="padding: 0">
                                ...
                                <img src="data:image/png;base64,<%= base64Image%>" style="width: 40px;margin-left: 41px;" class="user-image" alt="alt"
                                     name="<%= hr.getId()%>" data-image-src="data:image/png;base64,<%= base64Image%>" data-fname="<%= hr.getFname() %>" 
                                     data-lname="<%= hr.getLname() %>" data-contact="<%= hr.getContact()%>"
                                     data-dob="<%= createdAccountDateStr%>"  data-gender="<%= hr.getGender()%>"
                                     data-designationhr="<%=hr.getDegName()%>"
                                     data-email="<%= hr.getEmail() %>"
                                     data-createdaccount="<%= createdAccountDateStr%>" data-address="<%= hr.getAddress()%>"
                                     data-bs-toggle="modal" data-bs-target="#employeeDetails"
                                     />
                            </td>
                            <td class="textTranform">
                                ...
                                <div class="dropdown nav-icon">                   
                                    <div class="overflow-elisp dropdown-toggle nav-link-user"  data-bs-toggle="dropdown" style="width:70px;"><%= hr.getFname() +" "+ hr.getLname()%></div>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-large">
                                        <p class='text-xs text-muted px-3'>
                                            <%= hr.getFname() +" "+ hr.getLname()%>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <td>
                                 <div class="dropdown nav-icon">                   
                                    <div class="overflow-elisp dropdown-toggle nav-link-user"  data-bs-toggle="dropdown" style="width:82px;"><%= hr.getEmail()%></div>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-large">
                                        <p class='text-xs text-muted px-3'>
                                            <%= hr.getEmail()%>
                                        </p>
                            ...
                            <td>
                                ...
                                <%
                                    if(hr.getStatus() == 0){
                                %>
                                <a style="cursor: pointer" id="hrDeactive" class="hr-active-deactive"
                                   name="<%= hr.getId()%>" data-useridhr="<%= hr.getUser_id_hr()%>"
                                   data-role="<%= hr.getRole()%>"
                                   data-status="<%= hr.getStatus()%>"
                                   data-username="<%= hr.getFname() + " " + hr.getLname()%>"
                                 >
                                    <i class="fa fa-ban text-danger"></i>
                                </a>
                                <% }else{ %>
                                    <a style="cursor: pointer" id="hrActive" class="hr-active-deactive"
                                       name="<%= hr.getId()%>" data-useridhr="<%= hr.getUser_id_hr()%>"
                                       data-role="<%= hr.getRole()%>"
                                       data-status="<%= hr.getStatus()%>"
                                       data-username="<%= hr.getFname() + " " + hr.getLname()%>"
                            ...
                            <td style="padding-right: 0px;">
                                ...
                                <a style="cursor: pointer;padding-right: 5px;" name="<%= hr.getId()%>" class="hrEdit"
                                   data-image-src="data:image/png;base64,<%= base64Image%>" data-fname="<%= hr.getFname()%>"
                                   data-currentuserrole="<%= user.getRole()%>"
                                   data-lname="<%= hr.getLname()%>"
                                   data-useridhr="<%= hr.getUser_id_hr()%>" data-degidhr="<%= hr.getDeg_id_hr()%>"
                                   data-dob="<%= hr.getDob()%>"  data-gender="<%= hr.getGender()%>" data-email="<%= hr.getEmail()%>"
                                   data-createdaccount="<%= createdAccountDateStr%>" data-address="<%= hr.getAddress()%>"
                                   data-contact="<%= hr.getContact()%>" data-contact="<%= hr.getContact()%>"
                                   data-role="<%= hr.getRole()%>"
                                   data-getalldeg="<%= designationHrOptions%>"
                                   data-degname="<%= hr.getDegName()%>"
                                   data-bs-toggle="modal"  data-bs-target="#editHRModal"><i class="fa fa-pen text-info"></i>
                                </a>

                                <a style="cursor: pointer;padding-right: 5px" id="hrDelete" class="hr-delete"
                                   name="<%= hr.getId()%>" data-useridhr="<%= hr.getUser_id_hr()%>"
                                   data-username="<%= hr.getFname() +" "+hr.getLname()%>"
                                   >
            ...
            <div class="modal-body">
                <form class="form" id="addingUser" action="../AddSampleUser"  enctype="multipart/form-data" method="post">
                    <div class="row">
                        ...
                        <input type="hidden" value="HR" name="role" readonly/>
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select" name="designation" aria-label="Default select example" style="width: 100%;right: 0px;bottom: -39px;">
                                            ...
                                            <%
                                                ...
                                                List<Designation> degList = degDao.getHrAllDesignation();
...
<div class="modal fade" id="editHRModal" style="display:none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header primary-background text-white">
...
<script>
    ...
    $(document).ready(function () {
        $(".user-image").click(function () {
            ...
            var designationhr= $(this).data("designationhr");
           ...
           var modalContent = "<section class='vh-50' style='background-color: #f4f5f7;'><div class='container py-4 h-100'>";
            ...
            modalContent += "<p>"+designationhr+"</p>";                
            modalContent += "</div>";
            ...
            modalContent += "<div class='col-6 mb-6'><h6>Joning Date</h6>";
        ...
        $(".hrEdit").click(function () {
            ...
            var address = $(this).data("address");
            var contact = $(this).data("contact");
            var userIdHr= parseInt($(this).data("useridhr"));
...
//            var modalContent = "<div class='container text-center' style='padding-top: 18px;'>";
//            modalContent += "<img src='" + imageSrc + "' alt='Employee Image' class='img-fluid' style='max-width: 150px;border-radius: 50%;'></div>";
//
//            modalContent += "<form class='form' id='editUser' action='../UpdateUser' enctype='multipart/form-data' method='post'>";
//            modalContent += "<div class='modal-body'><div class='row'>";
//
//
//            modalContent += "<div class='col-md-6 col-12'><div class='form-group has-icon-left'>";
//            modalContent += "<label for='first-name-icon'>First Name</label>";
//            modalContent += "<div class='position-relative'>";
//            modalContent += "<input type='text' class='form-control' id='fname' name='fname' value='" + fname + "' autocomplete='off'>";
//            modalContent += "<input type='hidden' class='form-control' id='empId' name='empId' value='" + empId + "' readonly>";
//            modalContent += "<input type='hidden' class='form-control' id='userIdEmp' name='userIdEmp' value='" + userIdHr + "' readonly>";
//            modalContent += "<input type='hidden' class='form-control' id='role' name='role' value='" + role + "' readonly>";
//            modalContent += "<input type='hidden' name='currentRole' value='" + currentuserrole + "' readonly>";
...
//
//            modalContent += "<div class='col-md-6 col-12'><div class='form-group has-icon-left'>";
//            modalContent += "<label for='last-name-icon'>Last Name</label><div class='position-relative'>";
//            modalContent += "<input type='text' class='form-control' id='lname' name='lname' autocomplete='off' value='" + lname + "'>";
//            modalContent += "<div class='form-control-icon'><i class='fa fa-user'></i></div></div></div></div>";
//
//            modalContent += "<div class='col-md-6 col-1'><div class='form-group has-icon-left'>";
//            modalContent += "<label for='first-name-icon'>Email</label><div class='position-relative'>";
//            modalContent += "<input type='text' class='form-control' id='email' name='email' placeholder='email'value='" + email + "' autocomplete='off'>";
//            modalContent += "<div class='form-control-icon'><i class='fa fa-envelope'></i></div></div></div></div>";
//
//
//
//            modalContent += "<div class='col-md-6 col-12'><div class='form-group has-icon-left'><label for='first-name-icon'>Gender</label><div class='position-relative pt-2'>";
...
//
//            modalContent += "<div class='col-md-6 col-12'><div class='form-group has-icon-left'>";
//            modalContent += "<label for='first-name-icon'>Contact</label>";
//            modalContent += "<div class='position-relative'>";
//            modalContent += "<input type='text' class='form-control' id='contact' name='contact' value='" + contact + "' autocomplete='off'>";
//            modalContent += "<div class='form-control-icon'><i class='fa fa-user'></i></div></div></div></div>";
//
//            
//            modalContent += "<div class='col-md-6 col-12 mb-5'><div class='form-group has-icon-left'>";
...
//            modalContent += "<textarea class='form-control' id='address' rows='4' name='address'>" + address + "</textarea></div></div>";
//
//            modalContent += "<div class='col-md-12 col-12'><div class='form-group has-icon-left'>";
...
//            modalContent += "<button type='button' class='btn btn-secondary' data-bs-dismiss='modal' onclick='closeEditModal()'>Close</button>";
//            modalContent += "<button type='submit' class='btn btn-primary' id='submitButton' type='submit'>Save</button>";
//
//            modalContent += "</div></form>";
            ...
            modalContent += "<input type='hidden' class='form-control' id='degIdEmp' name='degIdEmp' value='" + degidemp + "' readonly>";
            modalContent += "<input type='hidden' class='form-control' id='empId' name='empId' value='" + empId + "' readonly>";
            modalContent += "<input type='hidden' class='form-control' id='userId' name='userIdEmp' value='" + userIdHr + "' readonly>";
            modalContent += "<input type='hidden' class='form-control' id='role' name='role' value='" + role + "' readonly>";
        ...
        $(".hr-active-deactive").click(function () {
            var id = parseInt($(this).attr("name"));
            var userId = parseInt($(this).data("useridhr"));
...
//            alert(empId);
        ...
        $(".hr-delete").click(function () {
            var hrId = parseInt($(this).attr("name"));
            var userIdHr = parseInt($(this).data("useridhr"));
            var username = $(this).data("username");
//            alert(empId);
            Swal.fire({
                  ...
                  $.ajax({
                    ...
                    error: function() {
                      Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'An error occurred while deleteing the Hr.'
                      });
                    }
                  });
                }
