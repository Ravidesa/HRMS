...
<%@ page import="com.entities.Employee,com.entities.Designation,com.helper.GetDesignationOptions,com.helper.ConnectionProvider" %>
...
<%
    ...
    Employee emp = empDao.getEmployee(user.getId());
                ...
                <div class="card mb-3" style="border-radius: .5rem;">
                    <div class="row g-0">
                        <div class="col-md-4 gradient-custom text-center text-white"
                            ...
                            <h5><%= emp.getFname() +" "+ emp.getLname() %></h5>
                            <p><%= emp.getDegName()%></p>
                            <a style="cursor: pointer;color: white" name="<%= emp.getId()%>" class="editPersonal"
                               data-image-src="data:image/png;base64,<%= base64Image%>" data-fname="<%= emp.getFname()%>"
                               data-lname="<%= emp.getLname()%>" data-email="<%= emp.getEmail()%>"
                               data-gender="<%= emp.getGender()%>" data-address="<%= emp.getAddress()%>"
                               ...
                               data-getalldeg="<%= designationOptions%>" data-degname="<%= emp.getDegName()%>"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row pt-1">
                                    <div class="col-6 mb-3">
                                        <h6>Email</h6>
                                        <p class="text-muted"><%= emp.getEmail()%></p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>Phone</h6>
                                        <p class="text-muted"><%= emp.getContact()%></p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>Birthday</h6>
                                    ...
                                    <div class="col-6 mb-3">
                                        <h6>Gender</h6>
                                        <p class="text-muted"><%= emp.getGender()%></p>
                                    </div>
                                    <div class="col-6 mb-6">
                                        <h6>Address</h6>
                                        <p class="text-muted"><%= emp.getAddress()%></p>
                                    </div>
                                    <div class="col-6 mb-6">
                                        <h6>Joining Date</h6>
                                        <p class="text-muted"><%= createdAccountDateStr%></p>
    ...
    <div class="modal-dialog modal-xl       ">
        <div class="modal-content">
            <div class="modal-header primary-background text-white">
                <h5 class="modal-title" id="exampleModalLabel"> Demo Edit </h5>
