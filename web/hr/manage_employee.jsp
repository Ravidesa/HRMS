    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <div class="addButton" data-bs-toggle="modal" data-bs-target="#exampleModal" style="display:flex; justify-content: end;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding: 0">
                                ...
                                <img src="data:image/png;base64,<%= base64Image%>" style="width: 40px;margin-left: 41px;" class="employeeDetails" alt="alt"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group has-icon-left">
                                ...
                                <span id="fnameError" class="errors text-danger"></span>
                            </div>
                        </div>  
...
<div class="modal fade" id="editEmployeeModal" style="display:none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header primary-background text-white">
                <h5 class="modal-title textTranform" id="headeForEdit">  </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <!--                    <span aria-hidden="true">&times;</span>-->
                </button>
            </div>
