...
CREATE TABLE `leavecategory` (
  `idLeaveCategory` int NOT NULL AUTO_INCREMENT,
  `catName` varchar(45) NOT NULL,
  `allocatedDays` int NOT NULL,
  PRIMARY KEY (`idLeaveCategory`)
...
INSERT INTO `leavecategory` VALUES (1,'Paid Leave',15),(2,'Unpaid Leave',8),(3,'Sick Leave',5);
