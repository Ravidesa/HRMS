...
<div class="main-content container-fluid">
    ...
    <section class="section">
        <div class="row mb-2">
            ...
            <div class="col-xl-4 col-md-12 mb-4">
                <a href="emp_manage_approved_leave.jsp">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between p-md-1">
                                <div class="d-flex flex-row">
                                    ...
                                    <div>
                                        <h4>Approved</h4>
                                        <h2 class="h1 mb-0"><%= dashObj.countAllApprovedLeaveOfEmp()%></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-md-12 mb-4">
                <a href="emp_manage_pending_leave.jsp">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between p-md-1">
                                <div class="d-flex flex-row">
                                    ...
                                    <div>
                                        <h4>Pending</h4>
                                        <h2 class="h1 mb-0"><%= dashObj.countAllPendingLeaveOfEmp()%></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-md-12 mb-4">
                <a href="emp_manage_rejected_leave.jsp" >
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between p-md-1">
                                <div class="d-flex flex-row">
                                    ...
                                    <div>
                                        <h4>Canceled</h4>
                                        <h2 class="h1 mb-0"><%= dashObj.countAllRejectedLeaveOfEmp()%></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
